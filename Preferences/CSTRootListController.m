...
- (void)viewDidLoad {
    ...
    self.preferences = [[HBPreferences alloc] initWithIdentifier:@"love.litten.crystalpreferences"];
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Crystal" message:@"Do you really want to reset your preferences?" preferredStyle:UIAlertControllerStyleActionSheet];
