#import "CSTContributorsSubPreferencesListController.h"

@implementation CSTContributorsSubPreferencesListController
...
- (void)loadFromSpecifier:(PSSpecifier *)specifier {
    ...
    NSString* sub = [specifier propertyForKey:@"CSTSub"];
